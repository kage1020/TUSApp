      ...
      <tbody>
        {data.map((person, index) => (
          <tr key={index}>
            ...
            <td>
              <button onClick={() => onTogglePresence(index)}>  
              変更              
              </button>
...
const App: React.FC = () => {
    ...
    return (
        <div className = "timedisplay">
          ...
          <div>
            入室時間: {enterTime}
            <button className="in" onClick={handleEnterTimeChange}>入室</button>
          </div>
          <div>
            退室時間: {exitTime}
            <button className="out" onClick={handleExitTimeChange}>退室</button>
          </div>
          <p></p>
          <button className="add" onClick={handleAddPerson}>追加</button>
          <p></p>
